...
use pvc\err\throwable\exception\pvc_exceptions\FileSystemException;
...
class FindFileTest extends TestCase
{
    ...
    {
        // is not readable.  The monkey patch include overrides is_readable to return false;
        $searchDir = __DIR__;
        include('MonkeyPatchIsReadable.php');
        self::expectException(InvalidArgumentException::class);
        $this->findFile->findFiles($searchDir);
    }
    ...
    {
        // filesystem exception.  The monkey patch include overrides opendir to return false;
        $searchDir = __DIR__;
        include('MonkeyPatchOpenDir.php');
