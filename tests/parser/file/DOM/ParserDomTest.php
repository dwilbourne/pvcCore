...
namespace tests\parser\file\DOM;

use DOMDocument;
use pvc\msg\UserMsgInterface;
use pvc\parser\file\DOM\err\InvalidMarkupLanguageException;
use pvc\parser\file\DOM\err\UnknownMarkupLanguageMsg;
use pvc\parser\file\DOM\ParserDOM;
...
class ParserDomTest extends TestCase
{
    ...
    public function testParseBadHTML4(): void
    {
        ...
        self::assertInstanceOf(UserMsgInterface::class, $this->parser->getErrmsg());
