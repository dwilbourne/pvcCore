 ...
 * another when they have the same key while using ArrayAccess syntax (e.g. $list[3] = 'foo' will overwrite
 * whatever is already at index 3).  To guard against this behavior, use add / push / update methods.
 *
 */
